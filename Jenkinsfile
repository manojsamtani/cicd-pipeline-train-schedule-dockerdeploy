pipeline {
    ...
    stages {
        ...
        stage('upload to nexus') {
            ...
            steps {
              nexusArtifactUploader artifacts: [[artifactId: 'users', classifier: '', file: 'users.tgz', type: 'tgz']], nexusVersion: 'nexus3', credentialsId: 'nexus-credentials', groupId: 'npm-hosted-repo', nexusUrl: '127.0.0.1:8081', protocol: 'http', repository: 'npm-hosted-repo', version: '1.2'
            }
        }
